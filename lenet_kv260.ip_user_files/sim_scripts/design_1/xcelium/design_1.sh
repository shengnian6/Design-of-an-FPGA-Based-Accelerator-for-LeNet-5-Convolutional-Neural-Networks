...
execute()
{
  xrun $xrun_opts \
       ...
       -f run.f \
       -top glbl \
       +incdir+"$ref_dir/../../../../lenet_kv260.gen/sources_1/bd/design_1/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../lenet_kv260.gen/sources_1/bd/design_1/ipshared/abef/hdl" \
       +incdir+"$ref_dir/../../../bd/design_1/ipshared/df45/src" \
       +incdir+"../../../../lenet_kv260.gen/sources_1/bd/design_1/ipshared/ec67/hdl" \
       +incdir+"../../../../lenet_kv260.gen/sources_1/bd/design_1/ipshared/abef/hdl" \
       +incdir+"../../../../lenet_kv260.gen/sources_1/bd/design_1/ipshared/df45/src" \
       +incdir+"D:/vivado2022.2/Vivado/2022.2/data/xilinx_vip/include" \
       -input simulate.do
}
