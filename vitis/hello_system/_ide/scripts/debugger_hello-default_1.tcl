...
# Path of this script: C:\Users\yeshe\Desktop\rep\code\lenet_kv260\vitis\hello_system\_ide\scripts\debugger_hello-default_1.tcl
# 
# 
# Usage with xsct:
# To debug using xsct, launch xsct and run below command
# source C:\Users\yeshe\Desktop\rep\code\lenet_kv260\vitis\hello_system\_ide\scripts\debugger_hello-default_1.tcl
# 
...
set bp_25_38_fsbl_bp [bpadd -addr &XFsbl_Exit]
con -block -timeout 60
bpremove $bp_25_38_fsbl_bp
targets -set -nocase -filter {name =~ "*A53*#0"}
rst -processor
