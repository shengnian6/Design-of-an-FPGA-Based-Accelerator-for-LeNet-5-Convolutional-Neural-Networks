...
set psu_pll_init_data {
    ...
    mask_write 0XFD1A0028 0x8000FFFF 0x80000032
		# : DDR_PLL INIT
...
set psu_mio_init_data {
    ...
    mask_write 0XFF18020C 0x00000FFF 0x0000000B
    ...
    mask_write 0XFF180170 0x03FFFFFF 0x00FCB00B
    ...
    mask_write 0XFF180184 0x03FFFFFF 0x03034FF4
		# : LOOPBACK
