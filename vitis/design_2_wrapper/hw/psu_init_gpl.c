...
/*##################################################################### */
    ...
    * Fractional value for the Feedback value.
    *  PSU_CRF_APB_APLL_FRAC_CFG_DATA                              0x32

    * Fractional control for the PLL
    * (OFFSET, MASK, VALUE)      (0XFD1A0028, 0x8000FFFFU ,0x80000032U)
    */
	PSU_Mask_Write(CRF_APB_APLL_FRAC_CFG_OFFSET,
		0x8000FFFFU, 0x80000032U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF18020C, 0x00000FFFU ,0x0000000BU)
    */
	PSU_Mask_Write(IOU_SLCR_MIO_MST_TRI2_OFFSET,
		0x00000FFFU, 0x0000000BU);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180170, 0x03FFFFFFU ,0x00FCB00BU)
    */
	PSU_Mask_Write(IOU_SLCR_BANK2_CTRL0_OFFSET,
		0x03FFFFFFU, 0x00FCB00BU);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180184, 0x03FFFFFFU ,0x03034FF4U)
    */
	PSU_Mask_Write(IOU_SLCR_BANK2_CTRL6_OFFSET,
		0x03FFFFFFU, 0x03034FF4U);
/*##################################################################### */
